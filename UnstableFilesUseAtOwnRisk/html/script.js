...
tcgCards.Open = function(pokemon) {
	container.style.visibility = "visible";
    document.getElementById("img").src = "img/" + pokemon + ".png";
}

tcgCards.Close = function() {
...
$(document).on('click', '.card', function(e){
    ...
    if (flippedcard1 === false) {
        ...
        setTimeout(() => { 
            ...
            $.post(`https://${GetParentResourceName()}/Rewardpokemon`, JSON.stringify({
                Pokemon: pokemon,
            }))
        }, 200);
